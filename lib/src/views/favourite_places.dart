                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => GestureDetector(
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (ctx)=>DetailPage(c: favourites[index])));
                        },
                        child: Padding(
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          IconButton(
                                            onPressed: () {
                                              setState(() {
                                                ref.read(favouritePlaceProvider.notifier)
                                                    .deleteFavouritePlace(favourites[index]);
                                              });
                                        ...
                                        children: [
                                          ...
                                          Center(
                                            child: RatingBar.builder(
                                              ...
                                              itemCount: favourites[index].rating.toInt(),
                                              itemSize: 20,
